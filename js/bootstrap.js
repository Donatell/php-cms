...
+function ($) {
    ...
    var Carousel = function (element, options) {
        ...
        !('ontouchstart' in document.documentElement) && this.$element
    ...
    Carousel.prototype.slide = function (type, next) {
        ...
        var slidEvent = $.Event('slid.bs.carousel',
            { relatedTarget: relatedTarget, direction: direction }); // yes,
                                                                    // "slid"
    ...
    var clickHandler = function (e) {
        ...
        var $this = $(this);
        var $target = $(
            $this.attr('data-target') || (href = $this.attr('href')) &&
...
+function ($) {
    ...
    Dropdown.prototype.toggle = function (e) {
        ...
        if (!isActive) {
            if ('ontouchstart' in document.documentElement &&
                ...
                // delegate
                $('<div class="dropdown-backdrop"/>').insertAfter($(this))
                    .on('click', clearMenus);
            }
    ...
    $(document)
        ...
        .on('keydown.bs.dropdown.data-api', '[role="menu"]',
            Dropdown.prototype.keydown)
        .on('keydown.bs.dropdown.data-api', '[role="listbox"]',
            Dropdown.prototype.keydown);
...
+function ($) {
    ...
    Modal.prototype.show = function (_relatedTarget) {
        ...
        this.backdrop(function () {
            ...
            transition ?
                that.$element.find(
                    '.modal-dialog') // wait for modal to slide in
                    .one('bsTransitionEnd', function () {
        ...
        .on('click.bs.modal.data-api', '[data-toggle="modal"]', function (e) {
            ...
            $target.one('show.bs.modal', function (showEvent) {
                if (showEvent.isDefaultPrevented()) {
                    return;
                } // only register focus restorer if modal will actually get
                  // shown
...
+function ($) {
    ...
    Tooltip.prototype.getOptions = function (options) {
        options =
            $.extend({}, this.getDefaults(), this.$element.data(), options);
    ...
    Tooltip.prototype.getPosition = function ($element) {
        ...
        var outerDims = isBody ?
            { width: $(window).width(), height: $(window).height() } : null;
        ...
        function (placement, pos, actualWidth, actualHeight) {
            ...
            if (/right|left/.test(placement)) {
                ...
                if (leftEdgeOffset < viewportDimensions.left) { // left overflow
                    ...
                    delta.left =
                        viewportDimensions.left + viewportDimensions.width -
                        rightEdgeOffset;
                }
            }
...
+function ($) {
    ...
    Popover.prototype.setContent = function () {
        ...
        // to do this manually by checking the contents.
...
+function ($) {
    ...
    Affix.prototype.getState =
        function (scrollHeight, height, offsetTop, offsetBottom) {
            ...
            if (offsetBottom != null &&
                (colliderTop + colliderHeight >= scrollHeight -
                    offsetBottom)) {
                return 'bottom';
            }
