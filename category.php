...
$post_count = count_published_posts_by_category_id($category_id);
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<?php
			$query =
				"SELECT * FROM posts WHERE post_category_id = $category_id AND post_status = 'published' LIMIT $from, $posts_per_page";
			...
			<nav>
				<ul class="pagination">
					...
					if ($current_page == '1') {
						...
						echo "<li><a href='category.php?cat_id=$category_id&page=$previous'><span>&laquo;</span></a></li>";
					}
					...
					for ($i = 1; $i <= $page_count; $i++) {
						if ($i == $current_page) {
							echo "<li class='active'><a href='category.php?cat_id=$category_id&page=$i'>$i</a></li>";
						} else {
							echo "<li><a href='category.php?cat_id=$category_id&page=$i'>$i</a></li>";
						}
					}
					...
					if ($current_page == $page_count) {
						...
						$next = $current_page + 1;
						echo "<li><a href='category.php?cat_id=$category_id&page=$next'><span>&raquo;</span></a></li>";
					}
